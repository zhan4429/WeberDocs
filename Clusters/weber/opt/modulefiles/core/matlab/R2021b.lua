...
prepend_path("PATH", "/apps/weber/matlab/R2021b/bin", ":")
prepend_path("CMAKE_PREFIX_PATH", "/apps/weber/matlab/R2021b/", ":")
setenv("MATLAB", "/apps/weber/matlab/R2021b")
setenv("MLROOT", "/apps/weber/matlab/R2021b")
setenv("ARCH", "glnxa64")
prepend_path("PATH", "/apps/weber/matlab/R2021b/bin/glnxa64", ":")
prepend_path("PATH", "/apps/weber/matlab/R2021b/bin", ":")
prepend_path("LD_LIBRARY_PATH", "/apps/weber/matlab/R2021b/runtime/glnxa64", ":")
prepend_path("LD_LIBRARY_PATH", "/apps/weber/matlab/R2021b/bin/glnxa64", ":")
